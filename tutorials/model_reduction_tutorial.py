# Depended on fast attribute for reactions in SBML which is now obsolete in the latest SBML level 3 version 2, so this is commented out. 
# from subsbml import *
...
# libsbml.writeSBML(DP1reduced.getSubsystemDoc(),'models/reducedDP.xml')

# # Use optional package bioscrape to simulate 
